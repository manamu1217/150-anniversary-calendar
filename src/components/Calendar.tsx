...
const Calendar: React.FC<CalendarProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* 左上の日時表示 */}
      <div className="absolute top-20 sm:top-4 left-4 text-white text-sm sm:text-lg md:text-xl lg:text-3xl xl:text-4xl font-bold leading-tight md:leading-[1.5] lg:leading-[1.8] xl:leading-[2]">
